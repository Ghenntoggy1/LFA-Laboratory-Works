...
class Variable_Expression(Node):
    ...
    def construct(cls, parser):
        # Expect 'Formula' keyword
        # if parser.next().has("Formula"):
        #     keyword = parser.take()
        # elif parser.next().has("Data"):
        #     return Data.construct(parser)
        # if not parser.next().of("VARIABLE_TYPE"):
        #     return FormulaOrData.construct(parser)
